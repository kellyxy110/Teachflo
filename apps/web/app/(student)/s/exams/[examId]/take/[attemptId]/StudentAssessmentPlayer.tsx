...
export function StudentAssessmentPlayer({ delivery }: { delivery: Delivery }) {
  ...
  return <div className="mx-auto max-w-3xl space-y-5">
    ...
    {expired && !submitted && <StatusMessage tone="warning" title="Attempt expired">Your saved progress is preserved. Submission is no longer available from this screen.</StatusMessage>}
